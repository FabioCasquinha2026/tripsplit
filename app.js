...
function renderTripSummary() {
  ...
  el.innerHTML = `
    ...
    <div class="summary-payments">
      ...
      ${
        payments ||
        '<span class="muted">Nenhum pagamento.</span>'
      }
    </div>
  `;
}
        ...
        p => `
          <label class="check">
            <input
              ...
              ${
                state.selectedParticipants.has(
                  p.id
                )
                  ? "checked"
                  : ""
